...
var require_factoryWithTypeCheckers = __commonJS({
  "node_modules/prop-types/factoryWithTypeCheckers.js"(exports, module2) {
    ...
    module2.exports = function(isValidElement6, throwOnDirectAccess) {
...
var require_react_is2 = __commonJS({
  "node_modules/@mui/utils/node_modules/react-is/index.js"(exports, module2) {
    "use strict";
    if (false) {
      module2.exports = null;
    } else {
...
var ClassNameConfiguratorContext = /* @__PURE__ */ React21.createContext(defaultContextValue);
...
function useSlotProps(parameters) {
  ...
  } = parameters, rest = _objectWithoutPropertiesLoose(parameters, _excluded10);
...
var TouchRipple = /* @__PURE__ */ React23.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const start2 = React23.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
...
var ButtonBase = /* @__PURE__ */ React24.forwardRef(function ButtonBase2(inProps, ref) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(ButtonBaseRoot, _extends({
    ...
    children: [children, enableTouchRipple ? (
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(TouchRipple_default, _extends({
        ref: handleRippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null]
...
var Close_default = createSvgIcon(/* @__PURE__ */ (0, import_jsx_runtime11.jsx)("path", {
...
var Portal = /* @__PURE__ */ React27.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(/* @__PURE__ */ React27.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(React27.Fragment, {
      children
    });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(React27.Fragment, {
...
var Popper = /* @__PURE__ */ React28.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(Portal, {
    disablePortal,
    container,
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React29.useRef(false);
  const firstFocus = React29.useRef(true);
  const inputRef = React29.useRef(null);
  const listboxRef = React29.useRef(null);
  const [anchorEl, setAnchorEl] = React29.useState(null);
  const [focusedTag, setFocusedTag] = React29.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React29.useRef(defaultHighlighted);
  ...
  const resetInputValue = React29.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React29.useState(true);
  ...
  const syncHighlightedIndex = React29.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React29.useRef(false);
...
var Popper3 = /* @__PURE__ */ React30.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
...
var ListSubheader = /* @__PURE__ */ React31.forwardRef(function ListSubheader2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiListSubheader"
  });
...
var Chip = /* @__PURE__ */ React33.forwardRef(function Chip2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const chipRef = React33.useRef(null);
  ...
  const ownerState = _extends({}, props, {
    ...
    size,
    color: color2,
    iconColor: /* @__PURE__ */ React33.isValidElement(iconProp) ? iconProp.props.color || color2 : color2,
    onDelete: !!onDelete,
    clickable,
    variant
  });
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && /* @__PURE__ */ React33.isValidElement(deleteIconProp) ? /* @__PURE__ */ React33.cloneElement(deleteIconProp, {
  ...
  let avatar = null;
  if (avatarProp && /* @__PURE__ */ React33.isValidElement(avatarProp)) {
    avatar = /* @__PURE__ */ React33.cloneElement(avatarProp, {
      className: clsx_default(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && /* @__PURE__ */ React33.isValidElement(iconProp)) {
    icon = /* @__PURE__ */ React33.cloneElement(iconProp, {
...
var ArrowDropDown_default = createSvgIcon(/* @__PURE__ */ (0, import_jsx_runtime19.jsx)("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
var Autocomplete = /* @__PURE__ */ React35.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const {
    ...
    ChipProps,
    className,
    clearIcon = _ClearIcon || (_ClearIcon = /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Close_default, {
      fontSize: "small"
    })),
    clearOnBlur = !props.freeSolo,
    clearOnEscape = false,
    ...
    popupIcon = _ArrowDropDownIcon || (_ArrowDropDownIcon = /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(ArrowDropDown_default, {})),
    readOnly = false,
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index) => /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Chip_default, _extends({
  ...
  if (limitTags > -1 && Array.isArray(startAdornment)) {
    ...
    if (!focused && more > 0) {
      ...
      startAdornment.push(/* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", {
        className: classes.tag,
        children: getLimitTagsText(more)
      }, startAdornment.length));
    }
  }
  const defaultRenderGroup = (params) => /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("li", {
    children: [/* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AutocompleteGroupLabel, {
      className: classes.groupLabel,
      ownerState,
      component: "div",
      children: params.group
    }), /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AutocompleteGroupUl, {
  ...
  const defaultRenderOption = (props2, option) => {
    return /* @__PURE__ */ (0, import_react8.createElement)("li", _extends({}, props2, {
      key: props2.key
    }), getOptionLabel(option));
  };
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(React35.Fragment, {
    children: [/* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AutocompleteRoot, _extends({
      ref,
      className: clsx_default(classes.root, className),
      ownerState
    }, getRootProps(other), {
      children: renderInput({
        ...
        InputProps: _extends({
          ...
          endAdornment: /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(AutocompleteEndAdornment, {
            className: classes.endAdornment,
            ownerState,
            children: [hasClearIcon ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AutocompleteClearIndicator, _extends({}, getClearProps(), {
              ...
              children: clearIcon
            })) : null, hasPopupIcon ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AutocompletePopupIndicator, _extends({}, getPopupIndicatorProps(), {
              disabled,
    ...
    })), anchorEl ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AutocompletePopper, _extends({
      as: PopperComponent,
      disablePortal,
      style: {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(AutocompletePaper, _extends({
        ownerState,
        as: PaperComponent
      }, paperSlotProps, {
        className: clsx_default(classes.paper, paperSlotProps == null ? void 0 : paperSlotProps.className),
        children: [loading && groupedOptions.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AutocompleteLoading, {
          className: classes.loading,
          ownerState,
          children: loadingText
        }) : null, groupedOptions.length === 0 && !freeSolo && !loading ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AutocompleteNoOptions, {
        ...
        }) : null, groupedOptions.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(AutocompleteListbox, _extends({
          as: ListboxComponent,
...
var Autocomplete3 = React36.forwardRef((props, ref) => {
  return /* @__PURE__ */ (0, import_jsx_runtime22.jsx)(Autocomplete_default, { ref, ...props });
});
