...
var maybeReactUseId = React2["useId"];
...
var EmotionCacheContext = /* @__PURE__ */ React9.createContext(
...
var Global = /* @__PURE__ */ withEmotionCache(function(props, cache) {
  ...
  if (!isBrowser2) {
    ...
    return /* @__PURE__ */ React10.createElement("style", (_ref = {}, _ref["data-emotion"] = cache.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = {
      __html: rules
...
var ClassNameConfiguratorContext = /* @__PURE__ */ React14.createContext(defaultContextValue);
function useClassNamesOverride(generateUtilityClass2) {
  const {
    disableDefaultClasses
  } = React14.useContext(ClassNameConfiguratorContext);
  return (slot) => {
...
var _excluded9 = ["elementType", "externalSlotProps", "ownerState"];
...
var Portal = /* @__PURE__ */ React15.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  ...
  const handleRef = useForkRef(/* @__PURE__ */ React15.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (/* @__PURE__ */ React15.isValidElement(children)) {
      ...
      return /* @__PURE__ */ React15.cloneElement(children, newProps);
    }
    return /* @__PURE__ */ _jsx2(React15.Fragment, {
      children
    });
  }
  return /* @__PURE__ */ _jsx2(React15.Fragment, {
...
var PopperTooltip = /* @__PURE__ */ React16.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx3(Root, _extends({}, rootProps, {
...
var Popper = /* @__PURE__ */ React16.forwardRef(function Popper2(props, forwardedRef) {
  ...
  return /* @__PURE__ */ _jsx3(Portal_default, {
    disablePortal,
    container,
    children: /* @__PURE__ */ _jsx3(PopperTooltip, _extends({
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var SvgIcon = /* @__PURE__ */ React18.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsxs(SvgIconRoot, _extends({
    ...
    ownerState,
    children: [children, titleAccess ? /* @__PURE__ */ _jsx4("title", {
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return /* @__PURE__ */ _jsx5(SvgIcon_default, _extends({
...
var TransitionGroupContext_default = React20.createContext(null);
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component === null) {
      return /* @__PURE__ */ React21.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children);
    }
    return /* @__PURE__ */ React21.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ React21.createElement(Component, props, children));
  };
...
var Paper = /* @__PURE__ */ React22.forwardRef(function Paper2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiPaper"
  });
  ...
  return /* @__PURE__ */ _jsx6(PaperRoot, _extends({
    as: component,
    ownerState,
    className: clsx_m_default(classes.root, className),
    ref
...
function Ripple(props) {
  ...
  return /* @__PURE__ */ _jsx7("span", {
    className: rippleClassName,
    style: rippleStyles,
    children: /* @__PURE__ */ _jsx7("span", {
...
var TouchRipple = /* @__PURE__ */ React24.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const startCommit = React24.useCallback((params) => {
    ...
    setRipples((oldRipples) => [...oldRipples, /* @__PURE__ */ _jsx8(TouchRippleRipple, {
      classes: {
  ...
  const start2 = React24.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  return /* @__PURE__ */ _jsx8(TouchRippleRoot, _extends({
    className: clsx_m_default(touchRippleClasses_default.root, classes.root, className),
    ref: container
  }, other, {
    children: /* @__PURE__ */ _jsx8(TransitionGroup_default, {
      component: null,
      exit: true,
      children: ripples
    })
...
var ButtonBase = /* @__PURE__ */ React25.forwardRef(function ButtonBase2(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsxs2(ButtonBaseRoot, _extends({
    ...
    children: [children, enableTouchRipple ? (
      ...
      /* @__PURE__ */ _jsx9(TouchRipple_default, _extends({
        ref: handleRippleRef,
        center: centerRipple
      }, TouchRippleProps))
    ) : null]
...
var IconButton = /* @__PURE__ */ React26.forwardRef(function IconButton2(inProps, ref) {
  ...
  return /* @__PURE__ */ _jsx10(IconButtonRoot, _extends({
    className: clsx_m_default(classes.root, className),
    centerRipple: true,
...
var Close_default = createSvgIcon(/* @__PURE__ */ _jsx11("path", {
...
var Popper3 = /* @__PURE__ */ React28.forwardRef(function Popper4(inProps, ref) {
  var _slots$root;
...
var ListSubheader = /* @__PURE__ */ React29.forwardRef(function ListSubheader2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiListSubheader"
  });
...
var Chip = /* @__PURE__ */ React31.forwardRef(function Chip2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiChip"
  });
  ...
  const ownerState = _extends({}, props, {
    ...
    size,
    color: color2,
    iconColor: /* @__PURE__ */ React31.isValidElement(iconProp) ? iconProp.props.color || color2 : color2,
    onDelete: !!onDelete,
    clickable,
    variant
  });
  ...
  let deleteIcon = null;
  if (onDelete) {
    deleteIcon = deleteIconProp && /* @__PURE__ */ React31.isValidElement(deleteIconProp) ? /* @__PURE__ */ React31.cloneElement(deleteIconProp, {
  ...
  let avatar = null;
  if (avatarProp && /* @__PURE__ */ React31.isValidElement(avatarProp)) {
    avatar = /* @__PURE__ */ React31.cloneElement(avatarProp, {
      className: clsx_m_default(classes.avatar, avatarProp.props.className)
    });
  }
  let icon = null;
  if (iconProp && /* @__PURE__ */ React31.isValidElement(iconProp)) {
    icon = /* @__PURE__ */ React31.cloneElement(iconProp, {
  ...
  return /* @__PURE__ */ _jsxs3(ChipRoot, _extends({
    as: component,
    className: clsx_m_default(classes.root, className),
...
var Autocomplete = /* @__PURE__ */ React33.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index) => /* @__PURE__ */ _jsx17(Chip_default, _extends({
  ...
  if (limitTags > -1 && Array.isArray(startAdornment)) {
    ...
    if (!focused && more > 0) {
      ...
      startAdornment.push(/* @__PURE__ */ _jsx17("span", {
        className: classes.tag,
        children: getLimitTagsText(more)
      }, startAdornment.length));
    }
  }
  const defaultRenderGroup = (params) => /* @__PURE__ */ _jsxs4("li", {
  ...
  const defaultRenderOption = (props2, option) => /* @__PURE__ */ _jsx17("li", _extends({}, props2, {
  ...
  return /* @__PURE__ */ _jsxs4(React33.Fragment, {
...
var Autocomplete3 = React34.forwardRef((props, ref) => {
  return /* @__PURE__ */ jsx(Autocomplete_default, __spreadValues({ ref }, props));
});
export {
